...
public class ItemRecipeInfo : ItemInfo
{
    ...
    public ItemRecipeInfo(Item item)
    {
        ...
        currItemRecipe.RequCountTiles(Requireds, Nums, Tiles, ref count, Items);
        canRecipe.RequCountTiles(CanRequireds, CanNums, CanTiles, ref canCount, Items, CanCreateItem);
    }
